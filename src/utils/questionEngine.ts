...
export const getQuestionsByWeek = (weekId: string): RuntimeQuestion[] => weekId === 'week-1' ? week1Pool : weekId === 'week-2' ? week2Pool : weekId === 'verified-extra' ? verifiedExtraPool : weekId === 'source-verified' ? sourceVerifiedPool : [];
